...
func (fake *FakeParseFunc) Spy(arg1 string, arg2 jwta.Claims, arg3 jwta.Keyfunc) (*jwta.Token, error) {
	...
	fake.recordInvocation("ParseFunc", []interface{}{arg1, arg2, arg3})
	fake.mutex.Unlock()
	if fake.Stub != nil {
...
func (fake *FakeParseFunc) recordInvocation(key string, args []interface{}) {
...
var _ jwt.ParseFunc = new(FakeParseFunc).Spy
